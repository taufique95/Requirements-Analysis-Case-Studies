...
| Project | Core Challenge | Key Deliverables |
| :--- | :--- | :--- |
| [**Smart Lotto Auto-Renew Engine**](./smart-lotto-auto-renew-engine/README.md) | Resolving billing logic flaws and "silent" subscription failures by merging Auto-Renew and Auto-Top-Up logic. | State flows, Edge-case mapping, Unified subscription logic. |

---
*Open to discussing complex logic modeling, process improvement, and shift-left QA strategies.*
